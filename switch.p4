...
// 1 is for true positives
// 2 is for false positives
counter(2, CounterType.packets) positives;
        ...
        */
        if(hdr.ethernet.isValid()) {
            if(hdr.ethernet.etherType == TYPE_IPV4) {
                if (hdr.ipv4.dstAddr == 0x0a000505) {
                    increment_counters.apply();
                }
